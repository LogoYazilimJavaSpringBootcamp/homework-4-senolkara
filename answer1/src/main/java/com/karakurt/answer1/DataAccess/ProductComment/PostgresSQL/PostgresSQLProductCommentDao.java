package com.karakurt.answer1.DataAccess.ProductComment.PostgresSQL;
...
public class PostgresSQLProductCommentDao implements IProductCommentDao {
    ...
    public PostgresSQLProductCommentDao(IProductCommentRepository iProductCommentRepository,
