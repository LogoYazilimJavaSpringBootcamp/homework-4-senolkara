package com.karakurt.answer1.DataAccess.Product.PostgresSQL;
...
public class PostgresSQLProductDao implements IProductDao {
    private static final Date date = Needs.getCurrentDate();
    private IProductRepository iProductRepository;

    public PostgresSQLProductDao(IProductRepository iProductRepository){
